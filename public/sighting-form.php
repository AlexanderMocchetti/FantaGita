...
<head>
    ...
    <title>Conferma scommessa</title>
                ...
                <div class="col-12 col-md-9 col-lg-7 col-xl-6">
                    <div class="card" style="border-radius: 15px; background-color: white;">
                        <div class="card-body p-5">
                            <h2 style="color: #080A0B" class="text-uppercase text-center mb-5">Invia richiesta su una scommessa</h2>
                            <form action="<?=htmlspecialchars($_SERVER['PHP_SELF']);?>" method="post">
                                <div class="form-outline mb-4">
                                    <textarea name="description" id="description" class="form-control form-control-lg" maxlength="100" placeholder="Descrizione motivo" required></textarea>
                                </div>
                                <h5 style="color: #080A0B" class="text-uppercase text-center mb-5">Scommessa su cui aprire la richiesta</h5>
                                <div class="form-outline mb-4">
                                        <?php 
...
if ($_SERVER['REQUEST_METHOD'] == 'POST')
{
    ...
    if (!isset($description) || !isset($bet))
    {
        exit();
    }
    if (insertSight($description,$bet,$_SESSION["id"],$conn))
    {
